...
{
    public class MotherLeftFatherRightConceiver : IConceiver
    {
        public IEnumerable<IBe> Conceive(IBe father, IBe mother)
        {
            ...
            return new[]
            {
                ...
                {
                    Rule = new Mushroom(mushroomRuleMotherRuleString.Take(splitIndex).Concat(mushroomRuleFatherRuleString.Skip(splitIndex)))
                }
            };
        }
    }
